...
for ws in worksets:
    ...
    elif "partitions wc" in name and workset_PartitionsWC is None:
        workset_PartitionsWC = ws
...
if not workset_placeholderARC:
    missing_worksets.append("Placeholder ARC")
if not workset_PartitionsWC:
    missing_worksets.append("Partitions WC")
...
FINISHES_KEYWORDS   = ("WLF","FINISH")
PARTITIONS_PREFIXES = ("H+A_ID_WAL", "ATR_ID_WAL")
CEILINGS_KEYWORDS   = ("CEI", "BULKHEAD")
PARTITIONWC_PREFIXES = ("ATR_ID_WAL_WC")
...
try:
    for wall in walls:
        ...
        # PARTITION WC
        if name_upper.startswith(PARTITIONWC_PREFIXES):
            target_workset = workset_PartitionsWC               
        
        # FINISHES
        elif any(keyword in name_upper for keyword in FINISHES_KEYWORDS):
        ...
        #PARTITIONS
            ...
            if name_upper.startswith(PARTITIONS_PREFIXES):
